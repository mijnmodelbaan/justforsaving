...
void NmraDcc::init( uint8_t ManufacturerId, uint8_t VersionId, uint8_t Flags, uint8_t OpsModeAddressBaseCV )
{
  ...
  ISRChkMask = DccProcState.ExtIntMask;
    ...
    ///////////////////////////////////////*********************************************************
    DB_PRINT("DccProcState.ExtIntNum:      %d", DccProcState.ExtIntNum)
    DB_PRINT("DccProcState.ExtIntPinNum:   %d", DccProcState.ExtIntPinNum)
    DB_PRINT("DccProcState.ExtIntPort:     %d", DccProcState.ExtIntPort)
    DB_PRINT("DccProcState.ExtIntMask:     %d", DccProcState.ExtIntMask)
    ///////////////////////////////////////*********************************************************
